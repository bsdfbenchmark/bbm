#ifndef _BBM_DRJIT_RANDOM_H_
#define _BBM_DRJIT_RANDOM_H_
...
/*! \filename random.h
  ...
  \brief Random number generator; built on top of Drjit
...
namespace backbone {
  ...
  ***********************************************************************/
  ...
  /**********************************************************************/
  /*! \brief Random generator wrapper around Drjit's PCG32
  ***********************************************************************/
  template<typename T>
    struct rng
  {
